...
/**
 * Breakpoints, largest first. The design is authored at **1440** (the Figma
 * frame), so that is the top base: at ≥1440 the layout scales **up** fully
 * proportionally (via `AdaptiveGrid`, `coef=1`), and 1024–1440 scales down —
 * so elements always occupy the same fraction of the viewport as in Figma.
 */
